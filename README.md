...
- **Routing:** React Router (HashRouter per SPA mode)
...
## 📂 Struttura ibrida
L'app è configurata per funzionare sia come **SPA tradizionale** (tramite `index.tsx`) sia come sito **generato staticamente** (tramite la cartella `pages/` e Vike), garantendo la massima compatibilità in ambienti di anteprima come Google AI Studio.
